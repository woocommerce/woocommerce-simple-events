...
use Automattic\WooCommerceSimpleEvents\Api\Queries\GetEvent as GetEventCommand;
...
class GetEvent {
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\WooCommerceSimpleEvents\Api\Infrastructure\ClassResolver::resolve_class( GetEventCommand::class );
