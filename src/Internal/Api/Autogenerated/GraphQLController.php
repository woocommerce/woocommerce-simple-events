...
class GraphQLController extends \Automattic\WooCommerce\Api\Infrastructure\GraphQLControllerBase {
	...
	protected function get_class_resolver_fqcn(): ?string {
		return \Automattic\WooCommerceSimpleEvents\Api\Infrastructure\ClassResolver::class;
	}

	protected function get_principal_resolver_fqcn(): ?string {
		return \Automattic\WooCommerceSimpleEvents\Api\Infrastructure\PrincipalResolver::class;
	}
	...
	protected function get_status_resolver(): ?object {
		return new \Automattic\WooCommerceSimpleEvents\Api\Infrastructure\HttpStatusResolver();
	}
}
